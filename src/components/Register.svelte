			...
			<div class="modal-body">
				...
				<form on:submit|preventDefault={handleRegister}>
					...
					<div class="mb-3">
						...
						<input type="password" class="form-control" id="register-passwordInput" bind:value={password}/>
					</div>
					<div class="mb-3">
						<label for="passwordInput" class="form-label">Confirm Password</label>
						<input type="password" class="form-control" id="register-confirmPasswordInput" bind:value={confirmPassword}/>
					</div>
