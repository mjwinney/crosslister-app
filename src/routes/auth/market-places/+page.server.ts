...
export const actions: Actions = {
    poshmarkSoldItems: async ({ request }) => {
        console.log('poshmarkSoldItems: ENTER');
        console.log('poshmarkSoldItems: request:', request);
        // const formData = await request.formData();
        // console.log('poshmarkSoldItems: request JSON:', JSON.stringify(formData));
        // const itemId = formData.get('itemId') as string;
        // const metaData: MetaDataModel = JSON.parse(formData.get('metaData') as string);
        // const userId = formData.get('userId') as string;

        // console.log('poshmarkSoldItems: userId:', userId);

        // const metaData = formData.get('metaData') as MetaDataModel;
        // Save the sold items to database
        ...
        console.log('poshmarkSoldItems: Poshmark API request successful, success');
